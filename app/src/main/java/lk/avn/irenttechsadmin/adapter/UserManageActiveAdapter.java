...
public class UserManageActiveAdapter extends RecyclerView.Adapter<UserManageActiveAdapter.ViewHolder> {
    private static final String TAG = UserManageActiveAdapter.class.getName();
    ...
    public UserManageActiveAdapter(ArrayList<UserData> products, Context context, OnItemClickListener listener) {
    ...
    @NonNull
    @Override
    public UserManageActiveAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View view = inflater.inflate(R.layout.manage_user_view, parent, false);
        return new UserManageActiveAdapter.ViewHolder(view, listener);

    }

    @Override
    public void onBindViewHolder(@NonNull UserManageActiveAdapter.ViewHolder holder, int position) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView,final OnItemClickListener listener) {
            ...
            user_status_btn.setText("Active");
            user_status_btn.setBackgroundTintList(ContextCompat.getColorStateList(context, R.color.green));
