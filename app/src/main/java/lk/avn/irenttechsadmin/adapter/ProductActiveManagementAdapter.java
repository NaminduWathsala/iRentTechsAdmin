...
public class ProductActiveManagementAdapter extends RecyclerView.Adapter<ProductActiveManagementAdapter.ViewHolder> {
    ...
    public ProductActiveManagementAdapter(List<Products> products, Context context, OnItemClickListener listener) {
    ...
    @NonNull
    @Override
    public ProductActiveManagementAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View view = inflater.inflate(R.layout.manage_product_view, parent, false);
        return new ProductActiveManagementAdapter.ViewHolder(view, listener);

    }

    @Override
    public void onBindViewHolder(@NonNull ProductActiveManagementAdapter.ViewHolder holder, int position) {
