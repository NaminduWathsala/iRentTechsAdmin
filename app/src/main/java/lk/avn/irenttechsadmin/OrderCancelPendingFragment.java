...
import lk.avn.irenttechsadmin.adapter.OrderCancelPendingAdapter;
...
public class OrderCancelPendingFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View fragment, @Nullable Bundle savedInstanceState) {
        ...
        orderCancelPendingAdapter = new OrderCancelPendingAdapter(invoices, getContext(), new OrderCancelPendingAdapter.OnItemClickListener() {
            ...
            @Override
            public void onCancelConfirmClick(int position) {
                String selectedProductId = orderCancelPendingAdapter.getDocumentId(position);
                button_text= "Yes";
                warning_name = "Do you want to confirm this cancellation?";
                new OrderCancelPendingFragment.WarningDialog("canceled",selectedProductId, position ,selectedProductId).show(getActivity().getSupportFragmentManager(), "Error");
            }

            @Override
            public void onCancelNotConfirmClick(int position) {
                String selectedProductId = orderCancelPendingAdapter.getDocumentId(position);
                button_text= "Yes";
                warning_name = "Do you not want to confirm this cancellation?";
                new OrderCancelPendingFragment.WarningDialog("pending",selectedProductId, position ,selectedProductId).show(getActivity().getSupportFragmentManager(), "Error");
            }
        });
        ...
        Query wishlist_query = wishlistCollection.whereEqualTo("status","cancel_pending");
                                        ...
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> updateTask) {
                                                if (updateTask.isSuccessful()) {
                                                    ...
                                                    orderCancelPendingAdapter.removeItem(position);
